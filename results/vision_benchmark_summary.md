...
- Dataset: test_images (image_folder_path=`/home/rlack/Projects/physical-ai-recycling-cell/test_images`, recursive_image_folder=False)
- Log directory: `logs/vision_benchmark`
...
| input_size | mode | avg_total_ms | avg_inference_ms | avg_fps | success | scan_completed | detections |
|---|---|---|---|---|---|---|---|
| 640 | end_to_end | 59.5 | 46.8 | 16.8 | 2/2 | True | cup.jpg:paper_cup(0.86);test.jpg:unknown(0.87)+unknown(0.60) |
| 416 | end_to_end | 29.7 | 25.6 | 37.3 | 2/2 | True | cup.jpg:paper_cup(0.95);test.jpg:unknown(0.95)+unknown(0.63) |
| 320 | end_to_end | 22.6 | 15.0 | 54.3 | 2/2 | True | cup.jpg:paper_cup(0.94);test.jpg:unknown(0.92) |
...
- However, with only 2 test images from the "test_images" dataset, this is not enough data to generalize whether accuracy degrades at smaller input sizes. Further validation with a larger, more varied set of real photographed recyclable-object images is needed before picking a production input_size based on speed alone.

## Limitations

- Only 2 test images from the "test_images" dataset; too small a sample to measure a real precision/recall drop at smaller sizes.
